...
all: driver.o struct_input.o linked_list.o graph.o constants.o traversal.o reader.o option_parser.o command_executor.o
	$(CC) -o $(EXE) driver.o struct_input.o linked_list.o graph.o constants.o traversal.o reader.o option_parser.o command_executor.o
